...
/// 程序生成模型文件
/// </summary>
public static class s_birthMesh  {
     /// <summary>
     /// 根据基础形状，沿着路径点，生成新的模型数据
     /// </summary>
     /// <param name="_mesh">生成的模型数据放入位置</param>
     /// <param name="_shape">基础形状</param>
     /// <param name="_path">路径点集</param>
     public static void fn_Extrude(Mesh _mesh, ExtrudeShape _shape, OrientedPoint[] _path)
     {
          //切面的点数量
