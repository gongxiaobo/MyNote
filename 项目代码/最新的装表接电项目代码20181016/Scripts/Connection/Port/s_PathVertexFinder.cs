...
namespace Assets.Scripts.Connection.Port
{
     ...
     {
          /// <summary>
          /// 根据路径平面类型，投影，找到链接的路径顺序点
          /// </summary>
          /// <param name="_port1">路径1</param>
          /// <param name="_port1ID">路径1中的路径编号</param>
          /// <param name="_port2">路径2</param>
          /// <param name="_port2ID">路径2中的路径编号</param>
          /// <param name="_wireName"></param>
          /// <param name="_wireR"></param>
          /// <returns></returns>
