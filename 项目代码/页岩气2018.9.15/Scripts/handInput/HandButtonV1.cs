...
namespace GasPowerGeneration
{
     ...
     public class HandButtonV1 : HandButton
     {
          ...
          protected override void Start()
          {
               ...
               {
                    mi_getcanHoldObj =  GetComponent<HandFindNearObj>(); 
               }
          }
          ...
          /// 手柄扳机键的按下
          /// </summary>
          protected virtual void fnp_triggerDown()
          {
               
               //Debug.Log("<color=blue>triggerdown</color>");
          ...
          /// 手柄扳机键弹起
          /// </summary>
          protected virtual void fnp_triggerUp()
          {
               if (m_isTriggerDown)
               {
                    //				Debug.Log ("扳机键松开");
          ...
          //全局事件，代码控制扳机键松开
          public void fn_GE_TriggerUp(GE_HandTriggerUp _para)
          {
               fnp_triggerUp();
          }
          //全局事件，代码控制扳机键按下
          public void fn_GE_HandTriggerDown(GE_HandTriggerDown _para)
          {
               fnp_triggerDown();
               //Debug.Log("<color=blue>triggerdown1</color>");
          }
          //是否选中旋钮
          private bool m_isHoldKnob = false;
          protected bool m_isTriggerDown = false;
          /// <summary>
