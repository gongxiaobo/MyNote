...
namespace Assets.Scripts.Connection.PointOnPlane
{
     ...
     /// 使用新的平面解决方案,得到点
     /// </summary>
     public class N_CaculateMode_1 : N_CaculateMode
     {
          protected AB_Plane m_plane = null;
          ...
          {
               //return base.fnp_WireKeyPoint(_Start, _end, _name, _wireR, _style, _startDis);
               if (m_plane == null)
               {
               ...
               {//折线的排线方式
                    ...
                    Vector3[] t_4 = m_plane.fn_project(new Vector3[2] { _Start, _end }, _name, t_r);
                    float t_dis = Vector3.Distance(t_project, t_4[0]);
                    Vector3[] t_4_1 = fnpArrangeStyle1(_Start, m_normal.fn_Normal(true), _startDis, m_plane.fn_getForward(), t_dis);
                    Vector3[] t_4_2 = fnpArrangeStyle1(_end, m_normal.fn_Normal(true), _startDis, m_plane.fn_getForward(), t_dis);
               ...
               else if (_style == E_CaculateMode.e_style1)
               {
                    ...
                    Vector3[] t_4 = m_plane.fn_project(new Vector3[2] { _Start, _end }, _name, t_r);
                    float t_dis = Vector3.Distance(t_project, t_4[0]);
                    Vector3 t_4_1 = fnp_ArangeStyle2(_Start, m_normal.fn_Normal(true), _startDis, m_plane.fn_getForward(), t_dis);
                    Vector3 t_4_2 = fnp_ArangeStyle2(_end, m_normal.fn_Normal(true), _startDis, m_plane.fn_getForward(), t_dis);
