...
namespace GasPowerGeneration
{
     ...
     public class N_state : AB_State, I_LightItem
     {
          ...
          private void fnp_debugInEditor()
          {
#if UNITY_EDITOR
               m_MainStateValue = fn_getMainValue();
               m_LockStateValue = fn_getMainValue(E_StateValueType.e_lock);
#endif
          }
          ...
          public void fni_refreshLightObj()
          {
               m_lightObj = null;
          }
          #endregion
          ...
          [SerializeField]
          protected string m_LockStateValue = "";
